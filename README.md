# mini-drs OpenAPI Specification
[![Build Status](https://travis-ci.com/jaeddy/redocly-test.svg?branch=master)](https://travis-ci.com/jaeddy/redocly-test)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://jaeddy.github.io/redocly-test/)
- [SwaggerUI](https://jaeddy.github.io/redocly-test/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://jaeddy.github.io/redocly-test/openapi.json) [YAML](https://jaeddy.github.io/redocly-test/openapi.yaml)
